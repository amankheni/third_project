...
class FormFillUpdialog extends StatefulWidget {
  const FormFillUpdialog({super.key});

  @override
  State<FormFillUpdialog> createState() => _FormFillUpdialogState();
}

class _FormFillUpdialogState extends State<FormFillUpdialog> {
  @override
  void dispose() {
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        const Text('Gender :- '),
                                        Text(FormFillupController
                                            .storData[index]['gender']),
                                      ],
                                    ),
                                    Row(
                                      children: [
